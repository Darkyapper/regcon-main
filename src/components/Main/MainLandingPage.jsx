  ...
  return (
    ...
    <div data-aos="fade-up" className='w-full'>
      <section className="relative min-h-screen bg-white">
        ...
        <div className="relative px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 z-10 bg-spheres">
          {/* Esferas */}
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-tight text-gray-800 md:text-3xl lg:text-5xl">
            ¡Haz que cada segundo cuente!
          </h1>

          <p className="mb-8  font-normal text-gray-600 lg:text-xl sm:px-16 lg:px-48">
